...
export default function ContactSection({ data }) {
  ...
  return (
    <section
      ref={sectionRef}
      id="contact"
      className="pt-16 md:py-16 bg-secondary relative"
    >
      <div className="container">
        <div className="flex flex-col max-md:gap-10">
          {/* TEXT LEFT */}
          <motion.div
            className="flex flex-col w-full md:w-1/2 md:pr-10"
          ...
          {image && (
            <motion.div
              className="w-screen max-md:-left-4 md:w-1/2 relative md:absolute md:top-0 md:right-0 md:h-full max-md:aspect-square"
